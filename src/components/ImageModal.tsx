...
const ImageModal = ({ isOpen, imageUrl, imageName, ingredients, onClose }: ImageModalProps) => {
  useEffect(() => {
    ...
    >
      ...
      >
        ...
        <div className="relative flex-1 overflow-hidden rounded-lg lg:rounded-r-none shadow-2xl bg-white">
          ...
          {/* Image title overlay - only show on mobile when no ingredients */}
        ...
        {/* Ingredients panel */}
        {ingredients && ingredients.length > 0 && (
          <div className="lg:w-80 bg-white p-6 overflow-y-auto rounded-lg lg:rounded-l-none">
